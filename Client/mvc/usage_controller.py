...
class UsageController:
    ...
    def update_usage_display(self, seconds_since_last, new_usage):
        ...
        print("total usage before: " + str(self.model.get_total_usage()))
        ...
        print("total usage: " + str(self.model.get_total_usage()))
        self.update_view()
